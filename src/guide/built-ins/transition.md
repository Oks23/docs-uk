...
1. Vue автоматично перевіряє чи застосовано до цільового елемента CSS переходи або анімацію. Якщо це так, кілька [класів переходу CSS](#transition-classes) буде додано/видалено у відповідний час.
